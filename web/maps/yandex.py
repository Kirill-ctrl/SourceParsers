...
from bs.maps.yandex import YandexParser
...
SOURCE_HTML_FILENAME = 'tmp/maps/source/source_yandex'  # общий файл для исходного html документа после прокрутки всех отзывов
RESULT_HTML_FILENAME = "results/maps/html/reviews_yandex"  # html file результатов парсинга
RESULT_JSON_FILENAME = "results/maps/json/reviews_yandex"  # html file результатов парсинга

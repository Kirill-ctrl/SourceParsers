...
from bs.maps.gis import GisParser
...
SOURCE_HTML_FILENAME = 'tmp/maps/source/source_gis'  # общий файл для исходного html документа после прокрутки всех отзывов
RESULT_HTML_FILENAME = "results/maps/html/reviews_gis"  # html file результатов парсинга
RESULT_JSON_FILENAME = "results/maps/json/reviews_gis"  # json file результатов парсинга

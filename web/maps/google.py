...
from bs.maps.google import GoogleParser
from src.middlewares import garbage_collector
from web.maps.interface import MapReviewsInterface
from src.base_reviews import BaseReviews
...
SOURCE_HTML_FILENAME = 'tmp/maps/source/source_google'  # общий файл для исходного html документа после прокрутки всех отзывов
RESULT_HTML_FILENAME = "results/maps/html/reviews_google"  # html file результатов парсинга
RESULT_JSON_FILENAME = "results/maps/json/reviews_google"  # json file результатов парсинга
...
class GoogleReviews(BaseReviews, MapReviewsInterface):
    ...
    def __init__(self, driver: webdriver.Chrome, data: dict):
        ...
        self.result_html_filename = RESULT_HTML_FILENAME + result_uuid + '.html'
        self.result_json_filename = RESULT_JSON_FILENAME + result_uuid + '.json'
